...
abacaba
Note
In the first test case, you can apply the operation of the second type (i.e., reverse the string s
) 4
 times. Then the string s
 will remain equal to cpm.

In the second test case, you can do the following:

Apply the operation of the second type, after which s
 will become equal to birg.
Apply operation of the first type (i.e., add the reversed string s
 to the end of the string s
), after which s
